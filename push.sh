...
adb push clkernel/gemm-blocking-4x4-vload4.cl $TEST_PATH/gemm-blocking-4x4-vload4.cl
adb push clkernel/gemm-noblock-vload8.cl $TEST_PATH/gemm-noblock-vload8.cl
#if [ -z $1 ]
#then
